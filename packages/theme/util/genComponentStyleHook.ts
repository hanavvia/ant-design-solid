...
//     useStyleRegister(
//       { ...sharedConfig, path: ['Shared', rootPrefixCls] },
//       () => [
//         {
//           // Link
//           '&': genLinkStyle(token)
...
//     return [
//       useStyleRegister(
//         { ...sharedConfig, path: [component, prefixCls, iconPrefixCls] },
//         () => {
//           const { token: proxyToken, flush } = statisticToken(token)

//           const customComponentToken = token[
//             component
//           ] as ComponentToken<ComponentName>
